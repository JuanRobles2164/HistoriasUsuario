...
<html lang="es">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo e(URL::asset('bootstrap-material-design.min.css')); ?>">
      <!-- Font Awesome V5.9.0 -->
   ...
   <body>
      ...
      <main class="full-box main-container">
         ...
         <section class="full-box nav-lateral">
            ...
            <div class="full-box nav-lateral-content">
               <figure class="full-box nav-lateral-avatar">
                  ...
                  <img src="<?php echo e(URL::asset('Images/Icons/avatar-1.svg')); ?>" class="img-fluid" alt="Avatar">
               ...
               <nav class="full-box nav-lateral-menu">
                  <ul>
                     <li>
                        <a href="<?php echo e(route('admin.getIndex')); ?>"><i class="fas fa-store-alt"></i> &nbsp; Inicio</a>
                     </li>
                     <li>
                        <a href="#" class="nav-btn-submenu"><i class="fas fa-users"></i> &nbsp; Usuarios <i class="fas fa-chevron-down"></i></a>
                        <ul>
                           <li>
                              <a href="<?php echo e(route('admin.getCreate')); ?>"><i class="fas fa-plus fa-fw"></i> &nbsp; Nuevo usuario</a>
                           </li>
                           <li>
                              <a href="<?php echo e(route('admin.getListUsuarios')); ?>"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista de usuarios</a>
                           </li>
                        </ul>
                     </li>
                  </ul>
         ...
         <section class="full-box page-content">
			...
			<a href="<?php echo e(route('admin.getSelfEdit')); ?>">
...
</html><?php /**PATH C:\wamp64\www\master-php\JuanRobles2164\HistoriasUsuario\resources\views/Home-admin.blade.php ENDPATH**/ ?>