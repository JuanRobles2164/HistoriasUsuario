...
<html lang="es">
   <head>
      ...
      <link href="{{URL::asset('JS/fullcalendar/packages/core/main.css')}}" rel='stylesheet' />
      <link href="{{URL::asset('JS/fullcalendar/packages/daygrid/main.css')}}" rel='stylesheet' />
  
   <script src="{{URL::asset('JS/fullcalendar/packages/core/main.js')}}"></script>
   <script src={{URL::asset('JS/fullcalendar/packages/daygrid/main.js')}}></script>
   <script src={{URL::asset('JS/fullcalendar/es.js')}}></script>
