! function(t, e) {
    ...
    function G(t) {
        de.isVisible() && et !== t.target.value && de.resetValidationMessage(), et = t.target.value
    }
        ...
        b(n, e.customClass, "header"), Bt(0, e),
            function(t, e) {
                ...
                if (n && e.type === n.type && N()) b(N(), e.customClass, "icon");
                    ...
                    if (At(), -1 !== Object.keys(B).indexOf(e.type)) {
                        var o = H(".".concat(k.icon, ".").concat(B[e.type]));
                        T(o), b(o, e.customClass, "icon"), E(o, "swal2-animate-".concat(e.type, "-icon"), e.animation)
                    } else g('Unknown type! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.type, '"'))
            }(t, e),
            function(t, e) {
                var n = _();
                if (!e.imageUrl) return O(n);
                T(n), n.setAttribute("src", e.imageUrl), n.setAttribute("alt", e.imageAlt), L(n, "width", e.imageWidth), L(n, "height", e.imageHeight), n.className = k.image, b(n, e.customClass, "image"), e.imageClass && nt(n, e.imageClass)
            }(0, e),
            function(t, e) {
                var n = D();
    ...
    function St(t, e) {
        ! function(t, e) {
            var n = rt();
            L(n, "width", e.width), L(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = k.popup, e.toast ? (nt([document.documentElement, document.body], k["toast-shown"]), nt(n, k.toast)) : nt(n, k.modal), b(n, e.customClass, "popup"), "string" == typeof e.customClass && nt(n, e.customClass), E(n, k.noanimation, !e.animation)
    ...
    var Ot = [],
        ...
        Rt = Object.freeze({
            ...
            queue: function(t) {
                ...
                function a(t, e) {
                    Ot = [], document.body.removeAttribute("data-swal2-queue-step"), t(e)
                }
                var s = [];
                return new Promise(function(i) {
                    ! function e(n, o) {
                        n < Ot.length ? (document.body.setAttribute("data-swal2-queue-step", n), r.fire(Ot[n]).then(function(t) {
    ...
    function Yt(t, e, n) {
        ...
        }), Mt.keydownHandlerAdded = !1), delete Mt.keydownHandler, delete Mt.keydownTarget, t.parentNode && t.parentNode.removeChild(t), ot([document.documentElement, document.body], [k.shown, k["height-auto"], k["no-backdrop"], k["toast-shown"], k["toast-column"]]), at() && (zt(), Kt(), Ft(), Zt())
    }
        ...
        if (n && !S(n, k.hide)) {
            ...
            ot(n, k.show), nt(n, k.hide), dt && j(n) ? n.addEventListener(dt, function(t) {
                t.target === n && function(t, e, n, o) {
                    S(t, k.hide) && Yt(e, n, o), Jt(ht), Jt(Qt)
                }(n, e, st(), a)
            }) : Yt(e, st(), a), null !== r && "function" == typeof r && r(n), i(t || {}), delete this.params
        }
    }
    var Jt = function(t) {
    ...
    function oe(t, e) {
        t.removeEventListener(dt, oe), e.style.overflowY = "auto"
    }

    function ie(t) {
        var e = q(),
            n = rt();
        null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), t.animation && (nt(n, k.show), nt(e, k.fade)), T(n), dt && j(n) ? (e.style.overflowY = "hidden", n.addEventListener(dt, oe.bind(null, n, e))) : e.style.overflowY = "auto", nt([document.documentElement, document.body, e], k.shown), t.heightAuto && t.backdrop && !t.toast && nt([document.documentElement, document.body], k["height-auto"]), at() && (t.scrollbarPadding && Dt(), function() {
            if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !S(document.body, k.iosfix)) {
                var t = document.body.scrollTop;
                document.body.style.top = -1 * t + "px", nt(document.body, k.iosfix), Wt()
            }
            ...
            e.scrollTop = 0
        })), st() || Mt.previousActiveElement || (Mt.previousActiveElement = document.activeElement), null !== t.onOpen && "function" == typeof t.onOpen && setTimeout(function() {
            t.onOpen(n)
        })
    }
    var re = void 0,
    ...
    var ue, ce = Object.freeze({
        ...
        enableConfirmButton: function() {
            h("Swal.disableConfirmButton()", "Swal.getConfirmButton().removeAttribute('disabled')"), Gt(this, ["confirmButton"], !1)
        },
        disableConfirmButton: function() {
            h("Swal.enableConfirmButton()", "Swal.getConfirmButton().setAttribute('disabled', '')"), Gt(this, ["confirmButton"], !0)
        },
        ...
        _main: function(t) {
            var c = this;
            ! function(t) {
                for (var e in t) Lt(i = e) || y('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== It.indexOf(o) && y('The parameter "'.concat(o, '" is incompatible with toasts'))), Tt(n = void 0) && h(n, Tt(n));
                var n, o, i
            }(t);
            var l = a({}, jt, t);
            ! function(e) {
            ...
            }(l), Object.freeze(l), Mt.timeout && (Mt.timeout.stop(), delete Mt.timeout), clearTimeout(Mt.restoreFocusTimeout);
            var d = {
                popup: rt(),
                container: q(),
                content: U(),
            ...
            return new Promise(function(t) {
                ...
                Qt.swalPromiseResolve.set(c, t), l.timer && (Mt.timeout = new ee(function() {
                    s("timer"), delete Mt.timeout
                }, l.timer));
                ...
                Mt.keydownTarget && Mt.keydownHandlerAdded && (Mt.keydownTarget.removeEventListener("keydown", Mt.keydownHandler, {
                    capture: Mt.keydownListenerCapture
                }), Mt.keydownHandlerAdded = !1), l.toast || (Mt.keydownHandler = function(t) {
                    return function(t, e) {
                ...
                }, Mt.keydownTarget = l.keydownListenerCapture ? window : d.popup, Mt.keydownListenerCapture = l.keydownListenerCapture, Mt.keydownTarget.addEventListener("keydown", Mt.keydownHandler, {
                    capture: Mt.keydownListenerCapture
                }), Mt.keydownHandlerAdded = !0), c.enableButtons(), c.hideLoading(), c.resetValidationMessage(), l.toast && (l.input || l.footer || l.showCloseButton) ? nt(document.body, k["toast-column"]) : ot(document.body, k["toast-column"]), "select" === l.input || "radio" === l.input ? function(e, n) {
                    function o(t) {
                    ...
                    O(o), n.inputValue.then(function(t) {
                        ...
                        g("Error in inputValue promise: " + t), o.value = "", T(o), o.focus(), re.hideLoading()
                    })
                }(c, l), ie(l), l.toast || (w(l.allowEnterKey) ? l.focusCancel && V(d.cancelButton) ? d.cancelButton.focus() : l.focusConfirm && V(d.confirmButton) ? d.confirmButton.focus() : a(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()), d.container.scrollTop = 0
            })
        },
        update: function(e) {
            var n = {};
    ...
    function le() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && g("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), ue = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    }, a(le.prototype, ce), a(le, Rt), Object.keys(ce).forEach(function(e) {
        le[e] = function() {
            var t;
            if (ue) return (t = ue)[e].apply(t, arguments)
        }
    }), le.DismissReason = C, le.version = "8.13.0";
    var de = le;
